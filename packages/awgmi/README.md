...
import {
  ...
  getDefaultProviders,
  defaultChains,
} from '@kazama-defi/awgmi';
import { PetraConnector } from '@kazama-defi/awgmi/connectors/petra'
import { MartianConnector } from '@kazama-defi/awgmi/connectors/martain'
...
import { FewchaConnector } from '@kazama-defi/awgmi/connectors/fewcha'
 ...
 // import { mainnet, testnet } from '@kazama-defi/awgmi/core'
...
## Connector
```jsx
import { useConnect, useDisconnect } from '@kazama-defi/awgmi'
...
### Send Transaction
```js
import { UserRejectedRequestError } from '@kazama-defi/awgmi'
