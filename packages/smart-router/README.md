...
`@kazama-defi/smart-router` is a SDK for getting best trade routes from Pancakeswap AMM.

## Install

```bash
$ pnpm add @kazama-defi/smart-router
```
...
```bash
$ pnpm add viem graphql-request @kazama-defi/sdk @kazama-defi/tokens
```
...
```typescript
import { Native } from '@kazama-defi/sdk'
import { SmartRouter } from '@kazama-defi/smart-router/evm'
...
```typescript
import { CurrencyAmount, TradeType } from '@kazama-defi/sdk'
...
import { SmartRouter, SmartRouterTrade, SMART_ROUTER_ADDRESSES, SwapRouter } from '@kazama-defi/smart-router/evm'
