...
import { CogIcon, HamburgerCloseIcon, HamburgerIcon, HomeIcon } from "../../../components/Svg";
...
const PanelTop: React.FC<Props> = ({ isPushed, pushNav, isMobile, gameContent }) => {
  ...
  return (
    <>
      <Container>
        ...
        <ItemsContainer>
          <TopItemsWrapper>{isPushed ? "h" : null}</TopItemsWrapper>
        </ItemsContainer>
        {/* {gameContent} */}
      </Container>
    </>
