...
const DataLabel = styled.div<{ isPushed: boolean }>`
  color: ${({ isPushed, theme }) => (isPushed ? "#a6a7aa" : "transparent")};
  transition: color 0.4s;
  flex-grow: 1;
  font-size: 13px;
...
const MenuEntry = styled.div<Props>`
  ...
  font-size: ${({ secondary }) => (secondary ? "0.9rem" : "0.9rem")};
...
export { MenuEntry, LinkStatus, DataLabel, LinkLabelMemo as LinkLabel };
