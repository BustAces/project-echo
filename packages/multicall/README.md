...
```bash
$ pnpm add @kazama-defi/multicall @kazama-defi/sdk viem
```
...
import { multicallByGasLimit, MulticallRequestWithGas } from '@kazama-defi/multicall'
...
```typescript
import { ChainId } from '@kazama-defi/chains'
import { getGasLimitOnChain } from '@kazama-defi/multicall'
