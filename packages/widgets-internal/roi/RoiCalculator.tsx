import { Currency, CurrencyAmount, Price, Token, ZERO, Percent, ZERO_PERCENT } from "@kazama-defi/sdk";
import { FeeAmount, FeeCalculator, TickMath, sqrtRatioX96ToPrice } from "@kazama-defi/v3-sdk";
import { useTranslation } from "@kazama-defi/localization";
import { useCallback, useMemo, useState } from "react";
import BigNumber from "bignumber.js";
import { BIG_ZERO } from "@kazama-defi/utils/bigNumber";
import { isPositionOutOfRange } from "@kazama-defi/utils/isPositionOutOfRange";
import { formatPercent, formatFraction, formatPrice } from "@kazama-defi/utils/formatFractions";

import { Button, DynamicSection, Flex, Message, MessageText, useMatchBreakpoints } from "@kazama-defi/uikit";

import { ScrollableContainer } from "@kazama-defi/uikit/components/RoiCalculatorModal/RoiCalculatorModal";
