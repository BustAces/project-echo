...
import { DEPLOYER_ADDRESSES } from '@kazama-defi/v3-sdk'
import { V3_QUOTER_ADDRESSES } from '@kazama-defi/smart-router/evm'
import { ICAKE } from '@kazama-defi/ifos'
import { CAKE_VAULT } from '@kazama-defi/pools'
