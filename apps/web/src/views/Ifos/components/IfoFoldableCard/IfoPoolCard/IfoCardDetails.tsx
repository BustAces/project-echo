...
import { CAKE } from '@kazama-defi/tokens'
import { Text, Flex, Box, Skeleton, TooltipText, useTooltip, IfoSkeletonCardDetails } from '@kazama-defi/uikit'
import { PublicIfoData, WalletIfoData } from 'views/Ifos/types'
import { useTranslation } from '@kazama-defi/localization'
import { Ifo, PoolIds } from '@kazama-defi/ifos'
import { BIG_ONE_HUNDRED } from '@kazama-defi/utils/bigNumber'
import { getBalanceNumber, formatNumber } from '@kazama-defi/utils/formatBalance'
import { useStablecoinPrice } from 'hooks/useBUSDPrice'
import { DAY_IN_SECONDS } from '@kazama-defi/utils/getTimePeriods'
