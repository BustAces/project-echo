...
import { formatBigIntToFixed } from '@kazama-defi/utils/formatBalance'
...
const ChainlinkChartWrapper = styled(Flex)<{ isMobile?: boolean }>`
  ...
  width: 100%;
  height: 100%;
  background: ${({ theme, isMobile }) => (isMobile ? theme.card.background : theme.colors.gradientKazamaStyle)};
`
