...
import { Button, Heading, Flex, useModal, AutoRenewIcon } from '@kazama-defi/uikit'
      ...
      return (
        <Flex alignItems="center" justifyContent="center">
          ...
          <Flex mx={['4px', null, '16px']} flexDirection="column" alignItems="center">
            <Heading textAlign="center" color="rgba(255, 255, 255, .7)">
              {t('Connect your wallet')}
            </Heading>
            <Heading textAlign="center" color="rgba(255, 255, 255, .7)" mb="24px">
