...
import { Text, PollIcon, PhotoIcon, VideoIcon, HeartLikeIcon, HeartLikeFilledIcon, CommentsIcon } from '@kazama-defi/uikit';
...
const LeftPart: React.FC<{ address: string }> = ({ address }) => {
