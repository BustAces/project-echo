...
const Ranking: React.FC<RankingProps> = ({ level, rankProgress }) => {
  // Changeable vars
  let imagePath1 = `${process.env.NEXT_PUBLIC_KAZAMA_RANK_IMAGE_PATH}/unranked_.png`
  let imagePath2 = `${process.env.NEXT_PUBLIC_KAZAMA_RANK_IMAGE_PATH}/unranked_.png`
  ...
  // Set styling data
  if (level === 0) {
    imagePath1 = `${process.env.NEXT_PUBLIC_KAZAMA_RANK_IMAGE_PATH}/unranked_.png`
    imagePath2 = `${process.env.NEXT_PUBLIC_KAZAMA_RANK_IMAGE_PATH}/unranked_.png`
