...
import {
    ArrowForwardIcon, Button, Heading, NextLinkFromReactRouter, Skeleton, Text, useMatchBreakpoints
...
const LotteryPrice: React.FC<React.PropsWithChildren> = () => {
  ...
  const prizeInBusd = new BigNumber(data.amountCollectedInCake).times(kazamaPriceBusd)
