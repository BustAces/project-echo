...
import { useIntersectionObserver } from '@kazama-defi/hooks';
import { useTranslation } from '@kazama-defi/localization';
import { cakeVaultV2ABI } from '@kazama-defi/pools';
import { bscTokens } from '@kazama-defi/tokens';
import { Balance, Flex, Heading, Skeleton, Text, useMatchBreakpoints } from '@kazama-defi/uikit';
import {
    formatBigInt, formatLocalisedCompactNumber, formatNumber
} from '@kazama-defi/utils/formatBalance';
