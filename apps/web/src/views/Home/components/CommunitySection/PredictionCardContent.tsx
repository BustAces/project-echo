...
import {
    ArrowForwardIcon, Button, Flex, Heading, NextLinkFromReactRouter, Skeleton, Text
} from '@kazama-defi/uikit';
import { formatLocalisedCompactNumber } from '@kazama-defi/utils/formatBalance';
...
const PredictionCardContent = () => {
  ...
  const { observerReuseCakePricecting } = useIntersectionObserver()
