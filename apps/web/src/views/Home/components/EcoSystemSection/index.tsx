import { Flex, Text, Box, ChevronRightIcon, useMatchBreakpoints, useModal } from '@kazama-defi/uikit'
...
export const CardWrapper = styled.div`
  border-radius: 24px;
  background: ${({ theme }) => (theme.isDark ? theme.colors.gradientKazamaStyle : theme.colors.backgroundAlt)};
  width: 100%;
