...
import { Currency, CurrencyAmount, Percent } from '@kazama-defi/sdk'
import { AutoColumn, Box, Button, CardBody, useModal } from '@kazama-defi/uikit'
import { ConfirmationModalContent } from '@kazama-defi/widgets-internal'

import { useDerivedPositionInfo } from 'hooks/v3/useDerivedPositionInfo'
import { useV3PositionFromTokenId, useV3TokenIdsByAccount } from 'hooks/v3/useV3Positions'
import useV3DerivedInfo from 'hooks/v3/useV3DerivedInfo'
import { FeeAmount, MasterChefV3, NonfungiblePositionManager } from '@kazama-defi/v3-sdk'
import { useCallback, useMemo, useState } from 'react'
import useTransactionDeadline from 'hooks/useTransactionDeadline'
import { useUserSlippage, useIsExpertMode } from '@kazama-defi/utils/user'
