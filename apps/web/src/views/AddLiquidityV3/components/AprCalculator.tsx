import { Currency, CurrencyAmount, Token, ZERO, Price } from '@kazama-defi/sdk'
import { TooltipText, Flex, CalculateIcon, Text, IconButton, QuestionHelper } from '@kazama-defi/uikit'
import {
  RoiCalculatorModalV2,
  RoiCalculatorPositionInfo,
  useRoi,
  useAmountsByUsdValue,
} from '@kazama-defi/widgets-internal/roi'
import { BIG_ZERO } from '@kazama-defi/utils/bigNumber'
import { encodeSqrtRatioX96, parseProtocolFees, Pool, FeeCalculator } from '@kazama-defi/v3-sdk'
import { useCallback, useMemo, useState } from 'react'
import { styled } from 'styled-components'
import { useTranslation } from '@kazama-defi/localization'
import { formatPrice } from '@kazama-defi/utils/formatFractions'
...
import { PositionDetails, getPositionFarmApr, getPositionFarmAprFactor } from '@kazama-defi/farms'
