...
import { Button, AutoRenewIcon, Box, Flex, Message, MessageText, Text } from '@kazama-defi/uikit'
import _noop from 'lodash/noop'
import { useTranslation } from '@kazama-defi/localization'
import isUndefinedOrNull from '@kazama-defi/utils/isUndefinedOrNull'
import { MAX_LOCK_DURATION } from '@kazama-defi/pools'
import BigNumber from 'bignumber.js'
import { getBalanceAmount, getDecimalAmount } from '@kazama-defi/utils/formatBalance'
