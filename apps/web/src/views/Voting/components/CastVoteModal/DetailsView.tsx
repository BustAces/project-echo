...
import { Flex, Text, Box, HelpIcon, useTooltip, RocketIcon, ScanLink, Link } from '@kazama-defi/uikit'
...
const FixedTermCardInner = styled(Box)<{ expired?: boolean }>`
  ...
  &:before {
    ...
    pointer-events: none;
    border-radius: ${({ theme }) => theme.radii.default};
    background: ${({ theme, expired }) => (expired ? 'rgba(255, 178, 55, 0.098)' : theme.colors.gradientKazamaStyle)};
  }
`
