...
import { LegacyPair as Pair } from '@kazama-defi/smart-router/legacy-router'
import { Modal, ModalV2, QuestionHelper, SearchIcon, Text, Flex, Link, AutoColumn } from '@kazama-defi/uikit'
