...
import { Button, Text, useModal, Box, Message, MessageText, AutoColumn, Dots } from '@kazama-defi/uikit'
import { confirmPriceImpactWithoutFee } from '@kazama-defi/widgets-internal'
import { useCallback, useEffect, useState, useMemo, memo } from 'react'
import { SMART_ROUTER_ADDRESSES, SmartRouterTrade } from '@kazama-defi/smart-router/evm'
