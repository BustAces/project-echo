import { Currency, CurrencyAmount, Fraction, Percent, Price, TradeType, ZERO_PERCENT } from '@kazama-defi/sdk'
...
import { RouteType, SmartRouterTrade } from '@kazama-defi/smart-router/evm'
