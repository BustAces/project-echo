import { useDebounce } from '@kazama-defi/hooks'
import { Currency, Trade, TradeType } from '@kazama-defi/sdk'
import { LegacyTradeWithStableSwap } from '@kazama-defi/smart-router/legacy-router'
import { SmartRouterTrade } from '@kazama-defi/smart-router/evm'
import { useExpertMode, useUserSlippage } from '@kazama-defi/utils/user'
