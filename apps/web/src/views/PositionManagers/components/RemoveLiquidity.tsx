...
import type { AtomBoxProps } from '@kazama-defi/uikit'
import { Box, Button, Flex, ModalV2, RowBetween, Text, useToast } from '@kazama-defi/uikit'
...
import { ConfirmationPendingContent, CurrencyLogo } from '@kazama-defi/widgets-internal'
