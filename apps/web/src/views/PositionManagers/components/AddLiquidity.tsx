...
import { MANAGER } from '@kazama-defi/position-managers'
import { Currency, CurrencyAmount, Percent } from '@kazama-defi/sdk'
import { Button, Flex, LinkExternal, ModalV2, RowBetween, Text, useToast } from '@kazama-defi/uikit'
...
import { ConfirmationPendingContent } from '@kazama-defi/widgets-internal'
