// import { serializeTokens } from '@kazama-defi/tokens/src/helpers'
import { ChainId, Pair } from '@kazama-defi/aptos-swap-sdk'
import type { SerializedFarmConfig } from '@kazama-defi/farms'
