import {
  ...
  Trade,
  TradeType,
} from '@kazama-defi/aptos-swap-sdk'
import { useAccount, useQuery } from '@kazama-defi/awgmi'
import { parseVmStatusError, SimulateTransactionError, UserRejectedRequestError } from '@kazama-defi/awgmi/core'
...
import { Swap as SwapUI, confirmPriceImpactWithoutFee } from '@kazama-defi/widgets-internal'

import replaceBrowserHistory from '@kazama-defi/utils/replaceBrowserHistory'
import tryParseAmount from '@kazama-defi/utils/tryParseAmount'
...
import { useIsExpertMode } from '@kazama-defi/utils/user/expertMode'
