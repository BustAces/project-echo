import { Coin, PAIR_LP_TYPE_TAG, Token } from '@kazama-defi/aptos-swap-sdk'
import { APTOS_COIN, isStructTag, useAccount, useAccountBalance, useAccountBalances } from '@kazama-defi/awgmi'
