import { useAccountResources, useTableItem } from '@kazama-defi/awgmi'
...
import { Coin, Pair, PAIR_LP_TYPE_TAG } from '@kazama-defi/aptos-swap-sdk'
import { CAKE_PID } from 'config/constants'
import { useInterval, useLastUpdated } from '@kazama-defi/hooks'
