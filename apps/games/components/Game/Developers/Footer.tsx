...
import { Box, Flex, Text, useMatchBreakpoints, Button, Link } from '@kazama-defi/uikit'
...
export const Footer = () => {
  ...
  return (
    <StyledContainer>
      ...
      <Wrapper>
        <Text mb="24px" fontWeight={600} color="rgba(255, 255, 255, .7)" textAlign="center" fontSize={isMobile ? 32 : 40}>
