...
import { GameType, PostersLayout, PostersItemData } from '@kazama-defi/games'
import { Flex, Box, Text, Button, CardHeader, Link, Card, TelegramIcon, useMatchBreakpoints } from '@kazama-defi/uikit'
